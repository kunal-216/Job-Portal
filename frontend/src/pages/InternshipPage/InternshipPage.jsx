      ...
      <div className="w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="p-6">
          <div className="flex items-center mb-6">
            ...
            />
            <div>
              <h1 className="text-3xl font-bold text-blue-600 mb-2">{internship.title}</h1>
              <h2 className="text-2xl font-semibold text-gray-800 mb-2">{internship.company}</h2>
              <p className="text-gray-600 mb-4">{internship.location || "Remote"}</p>
            </div>
          </div>
          ...
          <div className="mb-6">
            <h3 className="text-2xl font-semibold text-gray-800 mb-2">About the Internship</h3>
            ...
            <div className="flex flex-col gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-700">{internship.numberOfOpenings}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700 mb-4">{internship.about}</p>
          </div>
