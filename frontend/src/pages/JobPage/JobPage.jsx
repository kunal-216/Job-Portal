      ...
      <div className="w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="p-6">
          <div className="flex items-center mb-6">
            ...
            />
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-blue-600 mb-2">{job.title}</h1>
              <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-2">{job.company}</h2>
              <p className="text-gray-600 mb-4 text-[14px] md:text-[16px]">{job.location || "Remote"}</p>
            </div>
          </div>
          ...
          <div className="mb-6">
            <div className="flex flex-wrap gap-4 mb-6">
              ...
              <span className="bg-yellow-100 text-yellow-600 text-[16px] font-medium px-4 py-2 rounded-full">
          ...
          <div className="mb-6">
            <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-2">About the Job</h3>
            <p className="text-gray-700 mb-4 text-[14px] md:text-[16px]">{job.description}</p>

            <div className="flex flex-col gap-4 mb-6">
              <div>
                <h4 className="font-semibold text-gray-800 mb-2 text-xl md:text-2xl">Skills Required</h4>
              ...
              <div>
                ...
                <p className="text-gray-700 text-[14px] md:text-[16px]">{job.numberOfOpenings}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700 mb-4 text-[14px] md:text-[16px]">{job.about}</p>
          </div>
